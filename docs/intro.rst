...
the sequenced reads represent the intended target. To address these issues we
...
a positive selection of those reads who do. *sequ-into* creates a straightforward
